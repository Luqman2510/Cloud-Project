            ...
            <div class="flex">
                <!-- Logo -->
                 <a href="{{ route('dashboard') }}" class="flex items-center space-x-2">
                    <!-- Logo on the Left -->
                     <img src="{{ asset('storage/galleries/LOGO_KPPIM_BULAT.png') }}" alt="KPPIM Logo" class="h-6 w-6"> <!-- Adjusted logo size to match text -->
                     <!-- Text on the Right -->
                      <div>
                        <h1 class="text-sm font-bold text-indigo-100">KPPIM Event</h1> <!-- Adjusted text size -->
                        <hr class="border-t-2 border-indigo-400 w-16 mt-1"> <!-- Adjusted width of the line -->
                    </div>
                </a>
